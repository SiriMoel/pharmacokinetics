...
if frame > check_addiction_frame + 480 then
    if baramount > (baramount_old * 1) or baramount >= 450 then
    ...
    if addiction_level >= 3 then
        if GameGetGameEffectCount(player, "PHARMACOKINETICS_ADDICTION") == 0 then
